...
QUESTION3="Today is $TODAY. I was born in 1993-01-21. How old am I?"

# dfx canister call arcmindai_controller insert_goal "(record {goal = \"$QUESTION2\"; status = variant {Scheduled = null}})"
dfx canister call arcmindai_controller insert_goal "$QUESTION3"

# RESULT="Your first name is Henry."
# dfx canister call arcmindai_controller save_result "(0, \"$RESULT\")"
